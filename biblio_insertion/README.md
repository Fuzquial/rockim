...
| `2026-08-29_lot4_bilan_rockim.md` | **LOT 4** — bilan de rockim contre l'état de l'art. ⚠️ **CORRIGÉ PAR CONTRE-AUDIT** (129 verdicts, 52 confirmés) : ses **§1 et §3 ont été RÉCRITS le 2026-08-30**, versions d'origine conservées aux §1bis/§3bis, et **son plan §6 est REMPLACÉ** par celui de [`../chantier_imperial_2026-08-29/CONTRE_AUDIT_corrections.md`](../chantier_imperial_2026-08-29/CONTRE_AUDIT_corrections.md), qui fait foi. **État corrigé** : le résultat principal n'est pas « 117 attributions à un code qui n'est pas celui d'Imperial » — `solidity-solver-open` **EST** le dépôt public d'Imperial (LGPL-3.0) — mais **79 lignes** citant un `Y3D*.c` (dont 72 avec numéro de ligne) qui **ne sont pas reproductibles** faute d'ancrage de version. **Les deux « blocages » tombent** (h n'en est pas un : `pj = pf·E/h` est un produit ; et le chiffre applicable est 3,66 J / 6,9 %, pas 11,1 J / 20 %). Treize entrées d'avance sur Imperial, dont **neuf étaient trop flatteuses** : deux retirées, « résultats scientifiques » ramenés de quatre à un. Corrige les recommandations R2 et R4 du lot 3, toutes deux fausses. |
