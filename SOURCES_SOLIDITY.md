...
[`chantier_imperial_2026-08-29/A03_resourcer_attributions.md`](chantier_imperial_2026-08-29/A03_resourcer_attributions.md) §2.
...
| 10 | `Y3Did.c` **1017** | `ktss = 2.0/7.0·penalty` — rapport tangent/normal | `potTangentFactor / potPenaltyFactor` | **code public seul** ⚠️ **aucune valeur de k_t n'est publiée**, sur **8 sources** ([lot 2c §4](biblio_insertion/2026-08-29_lot2c_frottement_tangentiel.md), B9) |
