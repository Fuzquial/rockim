...
sur une suite de 104 contrôles — pour héberger un seul banc. C'est disproportionné,
...
|---|---|---|---|---|
| **V1 — scénario `slide`** | un scénario neuf dans le solveur de production | 1-2 j | **élevé** : 43 points de branchement, suite à 104 contrôles | le banc publié **à l'identique**, citable dans le manuscrit |
