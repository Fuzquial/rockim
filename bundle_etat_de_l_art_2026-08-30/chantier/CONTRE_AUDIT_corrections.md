...
[`biblio_insertion/2026-08-29_lot4_bilan_rockim.md`](../fiches/2026-08-29_lot4_bilan_rockim.md)
...
| **B9** ✅ **FAIT le 2026-08-30** | **Figer le compte des sources muettes sur une liste NOMINATIVE** (§9, M-11) | très faible | ✅ **8 sources nommées** dans une table du [lot 2c §4](../fiches/2026-08-29_lot2c_frottement_tangentiel.md) ; `k_t`, `η` et la règle de paire portent désormais **le même nombre**, et les quatre autres endroits y renvoient au lieu de recompter. L'IJNME 79 est explicitement **exclu**. Le « cinq sources » du lot 3 est conservé et **distingué** : c'est le corpus d'impact, une autre question |
...
*(Le [lot 2b](../fiches/2026-08-29_lot2b_couplage_endommagement_contact.md)
...
d'ailleurs déjà écrite au [lot 2b](../fiches/2026-08-29_lot2b_couplage_endommagement_contact.md)
