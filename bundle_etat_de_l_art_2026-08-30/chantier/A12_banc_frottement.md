...
J'avais porté A12 à **effort FAIBLE** dans le [lot 4](../fiches/2026-08-29_lot4_bilan_rockim.md)
...
sur une suite de 101 contrôles — pour héberger un seul banc. C'est disproportionné,
...
|---|---|---|---|---|
| **V1 — scénario `slide`** | un scénario neuf dans le solveur de production | 1-2 j | **élevé** : 43 points de branchement, suite à 101 contrôles | le banc publié **à l'identique**, citable dans le manuscrit |
